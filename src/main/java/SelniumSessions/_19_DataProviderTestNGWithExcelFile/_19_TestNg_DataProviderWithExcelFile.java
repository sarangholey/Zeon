package SelniumSessions._19_DataProviderTestNGWithExcelFile;
...
public class _19_TestNg_DataProviderWithExcelFile {
...
;	
	...
	@Test(dataProvider = "USA_UserData")
	...
	@DataProvider(name = "USA_UserData")
	public Object[][] USAuserData()
	{
		Object userinfo[][] = ExcelUtil.getTestData("US_Citizens");
		return userinfo;
