...
public class ExcelUtil {
	...
	public static String TESTDATA_SHEET_PATH = System.getProperty("user.dir")+"./src/main/java/SelniumSessions/_19_DataProviderTestNGWithExcelFile/DummyUserData.xlsx";
